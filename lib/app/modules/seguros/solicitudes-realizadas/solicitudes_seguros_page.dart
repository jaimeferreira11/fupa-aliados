...
class SolicitudesSegurosPage extends StatelessWidget {
  const SolicitudesSegurosPage({Key key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Container(
      child: GetBuilder<SolicitudesSegurosController>(
          builder: (_) => SafeArea(
                child: Stack(
                  children: [
                    DefaultTabController(
                      ...
                      child: Scaffold(
                          ...
                          body: GetBuilder<SolicitudesSegurosController>(
                            id: 'tabs',
...
class _Detalles extends StatelessWidget {
  final List<SolicitudSeguroModel> list;
